...
import { EntityTypes, PeopleService } from './types'

declare module 'fastify' {
  interface FastifyInstance {
    getSchema<T extends 'PeopleService'>(schemaId: T): {
      '$id': string,
      title: string,
      description: string,
      type: string,
...
interface AppEntityHooks {
  addEntityHooks(entityName: 'peopleService', hooks: EntityHooks<PeopleService>): any
}
